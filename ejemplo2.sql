						...
						ELSE
							...
							ELSE
								BEGIN
									...
									ELSE
										BEGIN
											SET @EXT = @CANTIDAD + @CANT
											UPDATE DETALLE_FACTURA SET CANTIDAD= @EXT WHERE NUM_FACTURA = @NUMFACTURA AND ID_PRODUCTO=@IDPRODUCTO
											SET @DESCRIPCION = (SELECT DESCRIPCION FROM PRODUCTOS WHERE ID_PRODUCTO = @IDPRODUCTO)
											--Aqui
											SET @MSJ= ' '+ CAST(@CANT AS varchar) + 'SE AGREGARON '+ CAST(@CANTIDAD AS varchar) + ' PRODUCTOS DE ' + CAST(@DESCRIPCION AS varchar)
										END
								END
						END
					END
